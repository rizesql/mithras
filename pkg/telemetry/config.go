...
func TracingFlags() *pflag.FlagSet {
	...
	f.String("tracing.urlpath", cfg.URLPath, "Tracer exporter URL path")
...
// 	Output   LogOutput         `mapstructure:"output"` // e.g., text, json
// 	Exporter string            `mapstructure:"exporter"`
// 	Endpoint string            `mapstructure:"endpoint"`
// 	Insecure bool              `mapstructure:"insecure"`
// 	URLPath  string            `mapstructure:"urlpath"`
...
type Metrics struct {
	...
	Endpoint string            `mapstructure:"endpoint"`
	Insecure bool              `mapstructure:"insecure"`
	URLPath  string            `mapstructure:"urlpath"` // Default /v1/metrics
	Headers  map[string]string `mapstructure:"headers"`
	Protocol Protocol          `mapstructure:"protocol"`
...
func MetricsFlags() *pflag.FlagSet {
	...
	f.String("metrics.urlpath", cfg.URLPath, "Metrics exporter URL path")
