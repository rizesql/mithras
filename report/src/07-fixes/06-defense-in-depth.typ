...
Prin refuzul de a acorda încredere parametrilor de identificare furnizați de client
(ex. ID-uri manipulate în corpul cererii sau în URL), sistemul neutralizează structural
