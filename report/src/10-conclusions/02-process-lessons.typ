...
Enumeration* sau *Predictable Token Attack*) în același limbaj de programare cu sistemul
vizat (Go) a permis reutilizarea logicii de concurență a goroutine-urilor și a
primitivelor de timing. Această simetrie între stack-ul de apărare și cel de atac oferă o
perspectivă unitară, reducând costul de context (context switch cognitiv) față de
utilizarea unor unelte externe și demonstrând versatilitatea platformei atât pentru
construirea, cât și pentru auditarea software-ului.
