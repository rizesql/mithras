// Clone of https://typst.app/universe/package/charged-ieee 0.1.4, in order to be able to
// control coluns count
...
#let ieee(
  ...
  show figure.where(kind: raw): set figure(supplement: [Cod], numbering: "1")
  ...
  show heading: it => {
    ...
    if it.level == 1 {
      ...
      set text(style: "italic")
      show: block.with(spacing: 7pt, sticky: true)
      if it.level == 3 {
        numbering("a.", deepest)
        h(7pt, weak: true)
      }
