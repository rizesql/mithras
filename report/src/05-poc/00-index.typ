...
utilizând scripturi ofensive dezvoltate special pentru acest audit (în directorul `exploits/`)
sau utilitare standard de interacțiune HTTP (`curl`).

Conform metodologiei *Build, Hack & Secure*, fiecare atac este prezentat într-un format
uniform, asigurând reproductibilitatea pas cu pas: precondiții, execuție, capturi de
ecran (care includ terminalul și identificarea unică a mediului de lucru) și rezultatul
obținut.
